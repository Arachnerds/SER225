...
public class TVPuzzle3 extends EnhancedMapTile {
    private String[] frames = {"DEFAULT", "SECOND", "THIRD"};
    private int currentFrameIndex = 0;

    public TVPuzzle3(Point location) {
        super(location.x, location.y, new SpriteSheet(ImageLoader.load("TVPuzzle3.png"), 48, 48), TileType.PASSABLE);
