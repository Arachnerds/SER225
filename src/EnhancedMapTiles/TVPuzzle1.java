...
public class TVPuzzle1 extends EnhancedMapTile {
    private String[] frames = {"DEFAULT", "SECOND", "THIRD"};
    private int currentFrameIndex = 0;

    public TVPuzzle1(Point location) {
        super(location.x, location.y, new SpriteSheet(ImageLoader.load("TVPuzzle1.png"), 48, 48), TileType.PASSABLE);
