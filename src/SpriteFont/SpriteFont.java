...
public class SpriteFont {
    ...
    public void centerTextX(int containerWidth, Graphics2D graphics) {
        int textWidth = getTextWidth(graphics);
        this.x = (containerWidth - textWidth) / 2;
    }

    // Center text vertically
    public void centerTextY(int containerHeight, Graphics2D graphics) {
        int ascent = getAscent(graphics);
        this.y = (containerHeight - ascent) / 2; // You can adjust this to center text properly vertically
    }

    private int getTextWidth(Graphics2D graphics) {
        FontMetrics fm = graphics.getFontMetrics(font);
