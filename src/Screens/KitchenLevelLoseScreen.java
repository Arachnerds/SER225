...
public class KitchenLevelLoseScreen extends Screen {
    protected PlayKitchenLevelScreen playKitchenLevelScreen;
    ...
    public KitchenLevelLoseScreen(PlayKitchenLevelScreen playLevelScreen) {
        this.playKitchenLevelScreen = playLevelScreen;
        initialize();
    }
    ...
    public void update() {
        ...
        if (!keyLocker.isKeyLocked(Key.SPACE) && Keyboard.isKeyDown(Key.SPACE)) {
            ...
            if (menuItemSelected == 0) {
                playKitchenLevelScreen.resetLevel();
            } else if (menuItemSelected == 1) {
                playKitchenLevelScreen.goBackToMenu();
            }
        }
    }
