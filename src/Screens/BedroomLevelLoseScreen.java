...
public class BedroomLevelLoseScreen extends Screen {
    protected PlayBedroomLevelScreen playBedroomLevelScreen;
    ...
    public void update() {
        ...
        if (!keyLocker.isKeyLocked(Key.SPACE) && Keyboard.isKeyDown(Key.SPACE)) {
            ...
            if (menuItemSelected == 0) {
                playBedroomLevelScreen.resetLevel();
            } else if (menuItemSelected == 1) {
                playBedroomLevelScreen.goBackToMenu();
            }
        }
    }
