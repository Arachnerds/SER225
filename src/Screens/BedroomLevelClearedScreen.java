...
// This class is for the level cleared screen for bedroom levels
public class BedroomLevelClearedScreen extends Screen {
    ...
    public BedroomLevelClearedScreen(ScreenCoordinator screenCoordinator) {
        ...
        String cutsceneImage = isArachnophobiaEnabled ? "levelFourCutsceneWalrus.png" : "levelFourCutscene.png";
