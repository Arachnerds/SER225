...
public class FinalLevelLoseScreen extends Screen {
    protected PlayFinalLevelScreen playFinalLevelScreen;
    ...
    public FinalLevelLoseScreen(PlayFinalLevelScreen playLevelScreen) {
        this.playFinalLevelScreen = playLevelScreen;
        initialize();
    }
    ...
    public void update() {
        ...
        if (!keyLocker.isKeyLocked(Key.SPACE) && Keyboard.isKeyDown(Key.SPACE)) {
            ...
            if (menuItemSelected == 0) {
                playFinalLevelScreen.resetLevel();
            } else if (menuItemSelected == 1) {
                playFinalLevelScreen.goBackToMenu();
            }
        }
    }
